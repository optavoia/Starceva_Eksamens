...
public class Frame9 extends JFrame {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					...
					Frame9 frame = new Frame9(pointManager);
	 ...
	 * Create the frame.
	 */
	public Frame9(PointManager pointManager) {
...
contentPane.setLayout(null);
		...
		//CheckBoxes
		cb1 = new JCheckBox("int[] arr = new int();");
		...
		cb2 = new JCheckBox("int[] arr = new int[];");
		cb2.setOpaque(false);
		...
		cb4 = new JCheckBox("int[] arr = new int[0];");
		cb4.setOpaque(false);
		...
		JLabel lblText2 = new JLabel("Kura no šīm metodēm nedarbosies");
		lblText2.setForeground(new Color(255, 255, 255));
		lblText2.setFont(new Font("Cherry Bomb One", Font.PLAIN, 35));
		lblText2.setBounds(137, 23, 549, 97);
		contentPane.add(lblText2);
		
		lblText2_1 = new JLabel("lai izveidotu tukšu masīvu?");
